...
import { Table, Space, Popconfirm, Tooltip, Button, Tag } from "antd";
...
import {
	fetchBlogUserDataProfile,
	removeBlogAction,
} from "app/actions/blogAction";
import ModalBlogUser from "./modalBlog";
...
function BlogUser(props) {
	...
	useEffect(() => {
		...
		dispatch(fetchBlogUserDataProfile(a));
	}, []);
