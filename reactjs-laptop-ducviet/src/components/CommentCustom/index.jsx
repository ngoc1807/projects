...
function CommentCustom(props) {
  ...
  return (
    <div className="CommentCustom" style={{ width: widthCustom }}>
      <div className="box">
            ...
            <div className="item">
              ...
              <div className="item__info">
                ...
                <div className="item__info-summary">
                  Dell N3579 có thiết kế rất hiện đại, mang dáng vẻ thời trang,
                  đáp ứng nhiều nhu cầu cụ thể, đòi hỏi khắt khe của người dùng.
                  Từ bộ xử lý mới nhất cho đến card đồ họa rời mạnh mẽ, Dell
                  N3579 làm cho mọi trải nghiệm trở nên tuyệt vời và chân thực
                  hơn.
                </div>
              </div>
            </div>
