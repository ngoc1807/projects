...
function ItemFilter(props) {
  return (
    <div className="ItemFilter container-fluid">
      <div className="row">
    ...
    <div className="BoxOne">
      <div class="BoxOne__label-item">
        <button
          ...
          id="btnMenuFilterMobile"
        >
          <ICON_FUNNEL_24 />
          <span className="text"> BỘ LỌC </span>
        </button>
        <div class="menu " id="MenuFilterMobile">
          ...
          <div class="menu-bottom">
            ...
            <button className="btn result" id="btnMenuFilterMobile">
              Xem kết quả
            </button>
          </div>
        </div>
      ...
      <div class="BoxOne__content-item">
        ...
        <div class="menu">
          ...
          <div class="menu-bottom">
            ...
            <button className="btn result" id="btnMenuFilterMenu">
              Xem kết quả
            </button>
          </div>
        </div>
      ...
      <div class="BoxOne__content-item">
        <button type="button" class="btn BoxOne__content-item-btn">
          <span className="text"> Giá cuc </span>
          <ICON_ARROW_DOWN_16 />
        </button>
        <div class="menu">
          <div className="menu-content">
